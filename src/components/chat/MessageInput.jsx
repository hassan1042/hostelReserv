...
const MessageInput = ({ userId, selectedHostel }) => {
  ...
  return (
    <div className="flex items-center space-x-2 mt-4">
      <input
        type="text"
        className="w-full px-4 py-2 border text-white border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring- dark:icons bg-bgInputsDark dark:text-text"
        placeholder="Any more queries? chat with the admin"
        value={message}
