...
function NewsLetter() {
  ...
  return (
    <section className=" bg-blue-500 dark:bg-cardDark text-white min-[250px]:p-1 min-[325px]:p-6  ">
 ...
 <h2 className= "text-xl sm:text-2xl font-bold mb-4">Stay Updated!</h2>
    ...
    <input type="email" placeholder="Enter your email" className="max-[235px]:w-[100px] max-sm:w-[150px] max-[300px]:text-[10px] p-1 py-2 min-[346px]:p-2 rounded-l-lg text-gray-500 dark:text-white dark:bg-slate-700"/>
